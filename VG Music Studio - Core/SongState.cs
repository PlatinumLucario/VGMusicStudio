...
public sealed class SongState
{
	...
	public const int MAX_TRACKS = 255 + 1; // PMD2 has a few songs with 18 tracks, where as PMD WiiWare has some that are up to 27 tracks, but made it 255 to future proof it
